...
class AnpelSpider(BaseSpider):
    ...
    def __init__(self, brands_urls=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        if brands_urls is None:
            self.brands_urls = default_brands_urls
        else:
            brands_urls = json.loads(brands_urls)
            self.brands_urls = brands_urls

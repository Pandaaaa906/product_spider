...
HOST_SCRAPYD = os.getenv('HOST_SCRAPYD', '127.0.0.1')
PORT_SCRAPYD = os.getenv('PORT_SCRAPYD', 6800)
...
SCRAPY_PROJECTS_DIR = os.getenv('SCRAPY_PROJECTS_DIR', '')
